...
{
    public class ReceiveFilter: FixedHeaderReceiveFilter<JsonCmdPackageInfo>
    {
        /// +-------+---+-------------------------------+
        /// |request| l |                               |
        /// | name  | e |    request body               |
        ...
        public override JsonCmdPackageInfo ResolvePackage(IBufferStream bufferStream)
        {
            //第三个参数用0,1都可以
            ...
            return new JsonCmdPackageInfo(header, bodyBuffer);
        }
    }
}
